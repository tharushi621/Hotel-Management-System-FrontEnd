      ...
      {[
        ...
        <div
          ...
          style={{
            ...
            height: `${m.h}%`,
            background:
              "linear-gradient(90deg, rgba(10,60,20,0.25) 0%, rgba(20,80,30,0.08) 60%, transparent 100%)",
            opacity: m.op,
      ...
      {[
        ...
        <div
          ...
          style={{
            ...
            height: `${m.h}%`,
            background:
              "linear-gradient(270deg, rgba(10,60,20,0.25) 0%, rgba(20,80,30,0.08) 60%, transparent 100%)",
            opacity: m.op,
            animation: `mistDrift ${m.dur}s ease-in-out ${m.del}s infinite alternate`,
            pointerEvents: "none",
          }}
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse at 50% 40%, #0e2e12 0%, #061208 45%, #020904 100%)",
            opacity: phase >= 1 ? 1 : 0,
        ...
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "repeating-linear-gradient(0deg, transparent, transparent 39px, rgba(201,168,76,0.018) 40px)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          ...
          <line
            ...
            x2="12"
            y2="588"
            stroke="url(#borderGradV)"
            strokeWidth="1.1"
            strokeDasharray="576"
            strokeDashoffset={phase >= 1 ? 0 : 600}
            style={{
              transition:
                "stroke-dashoffset 1.8s cubic-bezier(0.4,0,0.2,1) 0.5s",
            }}
          />
          <line
            x1="988"
            ...
            style={{
              transition:
                "stroke-dashoffset 1.8s cubic-bezier(0.4,0,0.2,1) 0.7s",
            }}
          />
          ...
          <line
            ...
            strokeDashoffset={phase >= 1 ? 0 : 952}
            style={{
              transition: "stroke-dashoffset 2s cubic-bezier(0.4,0,0.2,1) 0.9s",
            }}
          />
          <line
            x1="24"
            ...
            style={{
              transition:
                "stroke-dashoffset 1.8s cubic-bezier(0.4,0,0.2,1) 0.85s",
            }}
          />
          <line
            x1="976"
            ...
            style={{
              transition:
                "stroke-dashoffset 1.8s cubic-bezier(0.4,0,0.2,1) 0.95s",
            }}
          />
        </svg>
            ...
            {phase >= 3 && (
              <img
                ...
                style={{
                  ...
                  objectFit: "contain",
                  filter:
                    "drop-shadow(0 0 28px rgba(240,200,80,0.75)) drop-shadow(0 0 8px rgba(240,200,80,0.4))",
          ...
          >
            <button
              ...
              style={{
                ...
                color: "#0d1a0e",
                background:
                  "linear-gradient(135deg, #b8861e 0%, #f5e070 40%, #faf0a0 55%, #f0d060 70%, #c9951f 100%)",
                border: "none",
                borderRadius: "999px",
                padding: "18px 60px",
                cursor: "pointer",
                boxShadow:
                  "0 8px 40px rgba(240,200,80,0.55), 0 2px 12px rgba(0,0,0,0.5)",
        ...
        >
          <div
            style={{
              ...
              width: 36,
              background:
                "linear-gradient(90deg,transparent,rgba(240,200,80,0.5))",
            }}
          />
          {["Sri Lanka", "Nature", "Culture", "Heritage"].map((w, i) => (
            ...
            >
              ...
              {i < 3 && (
                <span
                  style={{ color: "rgba(240,200,80,0.45)", fontSize: "0.6rem" }}
                >
                  ◆
                </span>
              )}
          ...
          <div
            style={{
              ...
              width: 36,
              background:
                "linear-gradient(90deg,rgba(240,200,80,0.5),transparent)",
            }}
          />
        </div>
      </div>
