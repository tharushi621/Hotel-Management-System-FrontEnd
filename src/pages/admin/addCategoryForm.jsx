...
export default function AddCategoryForm() {
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full border-2 border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 p-3 rounded-lg outline-none"
              required
            />
          </div>
  ...
  <div className="relative">
    ...
    <input
      ...
      className="w-full border-2 border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 p-3 pl-7 rounded-lg outline-none"
      required
      step="0.01"
    />
  </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="w-full border-2 border-gray-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 p-3 rounded-lg outline-none resize-none"
            />
          </div>
          ...
          >
            {isLoading || imageUploading ? (
              <>
                ...
                <span>{imageUploading ? "Uploading Image..." : "Creating Category..."}</span>
              </>
            ) : (
              <>
                <FaUpload />
