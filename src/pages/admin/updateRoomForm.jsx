...
export default function UpdateRoomForm() {
  ...
  const [specialDescription, setSpecialDescription] = useState(
    existingRoom?.specialDescription || "",
  );
  ...
  const handlePhotoUpload = async (e) => {
    ...
    const url = await uploadMedia(
      file,
      `rooms/${existingRoom?.roomId || "temp"}`,
    );
    if (url) {
      ...
      <div className="lv-up-page">
        ...
        >
          <div style={{ marginBottom: 28 }}>
            ...
            >
              Edit the details for this retreat space.
            </p>
          </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} style={{ padding: "26px 28px" }}>
              ...
              >
                <div>
                  <label className="lv-up-label">
                    Category <span style={{ color: "#c0392b" }}>*</span>
                  </label>
                  <select
                    value={category}
                    onChange={(e) => setCategory(e.target.value)}
                    className="lv-up-input"
                    required
                  >
              ...
              <div style={{ marginBottom: 16 }}>
                <label className="lv-up-label">
                  Room Photos ({photos.length} uploaded)
                </label>
                ...
                >
                  ...
                  >
                    <FaUpload
                      style={{ color: "#9a7c3c", fontSize: "0.9rem" }}
                    />
                  </div>
                  <p
                    style={{
              ...
              >
                ...
                >
                  ...
                  <span>
                    Max Guests:{" "}
                    <strong style={{ color: "#2d3b2e" }}>{maxGuests}</strong>
                  </span>
                  <span>
                    Status:{" "}
                    <strong
                      style={{ color: available ? "#2e5c35" : "#b91c1c" }}
                    >
